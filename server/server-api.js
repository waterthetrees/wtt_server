...
const { getMap, getTree, getHistory, postNote } = require("./controller.js");
...
router.route("/tree").get(getTree).post(postNote);

router.route("/treemap").get(getMap);

router.route("/treehistory").get(getHistory);
