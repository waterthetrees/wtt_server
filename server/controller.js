const { getMapSubsetModel, getMapByCityModel, getTreeModel, getGeoJson, getTreeHistoryModel, postNoteModel } = require('./models/models_treeme.js');
...
function getTree(req, res) {
  ...
  logger.debug(`req  ${util.inspect(req.query, false, 10, true)} ${functionName} ASDFASDFASDFASDF`);
